  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <div className="bg-connect-accent text-white py-16 md:py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button className="bg-connect-accent">Browse Job Listings</Button>
                  <Button variant="outline">Professional Development</Button>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            <Card className="card-hover">
              <CardContent className="p-6">
                ...
                <Button className="w-full bg-connect-accent">View Details</Button>
              </CardContent>
            </Card>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <Button className="bg-connect-accent">Browse Certifications</Button>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <Button className="bg-connect-accent">Explore Programs</Button>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Call to Action */}
        <section className="section-padding bg-connect-accent text-white">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <Button size="lg" className="bg-white text-connect-accent hover:bg-gray-100">
